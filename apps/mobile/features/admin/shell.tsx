...
const ADMIN_TABS: ShellTab[] = [
  { href: "/admin", match: ["/admin", "/admin/index"], icon: "dashboard", label: "Home" },
  { href: "/admin/fees", match: ["/admin/fees"], icon: "payments", label: "Fees" },
  { href: "/admin/notices", match: ["/admin/notices"], icon: "campaign", label: "Notices" },
  { href: "/admin/profile", match: ["/admin/profile"], icon: "person-outline", label: "Profile" }
];

const PRINCIPAL_TABS: ShellTab[] = [
  { href: "/principal", match: ["/principal", "/principal/index"], icon: "dashboard", label: "Home" },
  { href: "/principal/staff", match: ["/principal/staff"], icon: "groups", label: "Staff" },
  { href: "/principal/approvals", match: ["/principal/approvals"], icon: "fact-check", label: "Approvals" },
  { href: "/principal/profile", match: ["/principal/profile"], icon: "person-outline", label: "Profile" }
];
