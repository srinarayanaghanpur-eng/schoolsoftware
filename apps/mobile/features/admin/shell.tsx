...
const ADMIN_TABS: ShellTab[] = [
  ...
  { href: "/admin/fees", match: ["/admin/fees"], icon: "receipt-long", label: "Fees", badge: 37 },
...
const PRINCIPAL_TABS: ShellTab[] = [
  ...
  { href: "/principal/approvals", match: ["/principal/approvals"], icon: "task-alt", label: "Verify", badge: 2 },
