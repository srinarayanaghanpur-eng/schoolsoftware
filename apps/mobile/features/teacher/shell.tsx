...
const TABS: ShellTab[] = [
  ...
  { href: "/teacher/academics", match: ["/teacher/academics"], icon: "menu-book", label: "Academics" },
  { href: "/teacher/inbox", match: ["/teacher/inbox"], icon: "mail-outline", label: "Inbox" },
  { href: "/teacher/profile", match: ["/teacher/profile"], icon: "person-outline", label: "Profile" }
];
