...
const firebaseCommonJsModules = {
  ...
  "@firebase/logger": path.resolve(workspaceNodeModules, "@firebase/logger/dist/index.cjs.js"),
  "@firebase/util": path.resolve(workspaceNodeModules, "@firebase/util/dist/index.cjs.js")
};
