...
export default function CreateBusFinancePage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/admin/finance/bus-emi/${res.id}`);
    } catch (err) {
  ...
  return (
    <>
      ...
      <section className="p-4 md:p-7">
        ...
        <Link href="/admin/finance/bus-emi" className="mb-4 inline-flex items-center gap-1 text-sm font-semibold text-[#3033a1]">
        ...
        <form onSubmit={submit} className="card grid max-w-4xl grid-cols-1 gap-4 p-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2 flex items-center gap-3">
            ...
            <Link href="/admin/finance/bus-emi" className="btn-secondary">Cancel</Link>
          </div>
        </form>
      </section>
    </>
