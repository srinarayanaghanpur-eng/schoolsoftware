...
const contextSubnavs: ContextSubnav[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/finance/bus-emi", label: "Bus EMI Management", icon: Wallet, module: "bus_finance" },
...
const routeModules: Array<{ prefix: string; module: Module }> = [
  { prefix: "/admin/finance/bus-emi", module: "bus_finance" },
...
// The dashboard academic-year switcher was removed. The academic year is chosen
// once on the Login screen and stored in AcademicYearContext (persisted to
// localStorage) for the whole session. Future switching, if ever needed, lives
// only in Settings → Academic Year Management for authorized admins.
