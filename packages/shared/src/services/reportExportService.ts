...
export function buildSalaryRows(reports: SalaryReport[]) {
  return reports.map((report) => ({
    ...
    "CL used (approved leave)": report.clUsedFromAbsent,
    ...
    "Approved leave CL days": report.approvedLeaveCLDays,
    "Attended leave days": report.attendedApprovedLeaveDays,
    ...
    "Salary deduction": report.salaryDeduction,
